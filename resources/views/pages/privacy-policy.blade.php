...
@section('title', 'Privacy policy of InstaNavigation project')

@section('content')

    <div class="container">
        <div class="content-block-wrapper mt-5 mb-4">
                    ...
                    <div class="tab-content translations-content-item en visible" id="en">
                        ...
                        <ul>
                            ...
                            <li>
                                <p><strong>Service Provider</strong> means any natural or legal person who processes
                                    ...
                                    to facilitate the Service, to provide the Service on behalf of the Company, to
                                    perform services
                        ...
                        <ul>
                            ...
                            <li><strong>Flash Cookies.</strong> Certain features of our Service may use local stored
                                ...
                                activity on our
                                Service. Flash Cookies are not managed by the same browser settings as those used
                                for Browser
                                Cookies. For more information on how You can delete Flash Cookies, please read
                                "Where can I change
                                the settings for disabling, or deleting local shared objects?" available at <a
                        ...
                        <p>Cookies can be "Persistent" or "Session" Cookies. Persistent Cookies remain on Your
                            ...
                            mobile device when You go offline, while Session Cookies are deleted as soon as You
                            close Your web
                            browser.</p>
                        ...
                        <ul>
                            <li>
                                ...
                                <p>Purpose: These Cookies are essential to provide You with services available
                                    through the Website
                                    and to enable You to use some of its features. They help to authenticate users
                                    and prevent
                        ...
                        <p>The Company will also retain Usage Data for internal analysis purposes. Usage Data is
                            generally retained
                            for a shorter period of time, except when this data is used to strengthen the security
                            or to improve the
                        ...
                        <p>Your information, including Personal Data, is processed at the Company's operating
                            offices and in any
                            other places where the parties involved in the processing are located. It means that
                            this information
                            may be transferred to — and maintained on — computers located outside of Your state,
                            province, country
                            or other governmental jurisdiction where the data protection laws may differ than those
                            from Your
                            jurisdiction.</p>
                        ...
                        <ul>
                            <li>By email: <a href="cdn-cgi/l/email-protection.html" class="__cf_email__"
                                    data-cfemail="e68f888089a68f889592878887908f8187928f8988c885898b">[email&#160;protected]</a>
                            </li>
                        </ul>
                    </div>
                </div>
