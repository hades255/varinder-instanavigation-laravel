    <footer class="footer mt-auto">
        <div class="container">
                    ...
                    <div class="d-flex align-items-center">
                        ...
                        <div class="text-white">
                            <p class="footer__logo-text">
                                ...
                                with Instagram. All content belongs to the content authors.
                                Download is available for informational purposes only.
                            </p>
                        </div>
                    </div>
                </div>
            ...
            <div class="row d-flex flex-wrap-reverse flex-md-nowrap mt-2 mt-md-0">
                <div class="col-md-4">
                    <p class="footer-sub text-white fw-normal">
                        © 2023 InstaNavigation. All rights reserved.
                    </p>
                </div>
                <div
